            ...
            <div>
                <div class="relative rounded-xl border border-slate-200 hover:border-slate-300 focus-within:border-brand-500 focus-within:ring-2 focus-within:ring-brand-500/20 bg-white transition px-4 pt-3 pb-2.5">
                    ...
                    <div class="flex items-start gap-3 pt-0.5">
                        ...
                        <textarea id="create_cat_default_notes" name="default_notes_raw" rows="2" placeholder="Contoh: Less Sugar, Less Ice, Ekstra Pedas, Tanpa Bawang..." class="w-full bg-transparent border-0 p-0 text-xs font-medium text-slate-800 placeholder-slate-400 focus:ring-0 focus:outline-none resize-none">{{ old('_method') ? '' : old('default_notes_raw') }}</textarea>
                    </div>
                </div>
                <div class="mt-1.5 flex flex-wrap items-center gap-1.5 text-[10px] text-slate-400 px-1">
                    ...
                    <button type="button" onclick="appendCreateNotePreset('Less Sugar, Less Ice, Normal Sugar, Panas')" class="px-2 py-0.5 rounded-md bg-slate-100 hover:bg-slate-200 text-slate-600 transition">+ Minuman</button>
                    <button type="button" onclick="appendCreateNotePreset('Pedas Sedang, Ekstra Pedas, Tidak Pedas, Tanpa Bawang, Pisah Sambal')" class="px-2 py-0.5 rounded-md bg-slate-100 hover:bg-slate-200 text-slate-600 transition">+ Makanan</button>
                    <button type="button" onclick="appendCreateNotePreset('Bungkus Terpisah, Kado, Cek Kondisi')" class="px-2 py-0.5 rounded-md bg-slate-100 hover:bg-slate-200 text-slate-600 transition">+ Retail</button>
                </div>
            </div>
